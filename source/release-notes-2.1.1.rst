...
GitHub`_. |proxysql| offers the `ProxySQL documentation`_. For more information on the issues fixed, features, or enhancements, see the |proxysql| `2.1.0 release notes <https://github.com/sysown/proxysql/releases/tag/v2.1.0>`__
and `2.1.1 release notes <https://github.com/sysown/proxysql/releases/tag/v2.1.1>`__
