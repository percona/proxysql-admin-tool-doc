.. _proxysql-release-notes-2.0.15:
...
* :jira:`PSQLADM-92`: Allow the use of an encrypted password in proxysql-admin

.. include:: _res/text/license.txt

.. |date| replace:: November 17, 2020
.. |release| replace:: 2.0.15
